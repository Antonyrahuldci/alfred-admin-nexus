    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage plans, pricing, and subscriber data</p>
        </div>
          ...
          <Card key={plan.name} className="overflow-hidden bg-gradient-card">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-2xl font-bold">{plan.subscribers.toLocaleString()}</span>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between rounded-lg border border-border p-3">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">20% off for 3 months</p>
                </div>
                <Badge>Active</Badge>
              </div>
              <div className="flex items-center justify-between rounded-lg border border-border p-3">
