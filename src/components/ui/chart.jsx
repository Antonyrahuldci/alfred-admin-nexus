                ...
                _jsxs(_Fragment, { children: [
                  ...
                  _jsxs("div", {
                    ...
                    _jsxs("div", { className: "grid gap-1.5", children: [
                      nestLabel ? tooltipLabel : null,
                      _jsx("span", { className: "text-muted-foreground", children: itemConfig?.label || item.name })] }
                    ),
                    item.value &&
...
const ChartLegendContent = React.forwardRef(
  ...
  ({ className, hideIcon = false, payload, verticalAlign = "bottom", nameKey }, ref) => {
    ...
    return (
      _jsx("div", {
        ref: ref,
        className: cn("flex items-center justify-center gap-4", verticalAlign === "top" ? "pb-3" : "pt-3", className), children:
        ...
        payload.map((item) => {
          ...
          return (
            _jsxs("div", {
              ...
              className: cn("flex items-center gap-1.5 [&>svg]:h-3 [&>svg]:w-3 [&>svg]:text-muted-foreground"), children: [
